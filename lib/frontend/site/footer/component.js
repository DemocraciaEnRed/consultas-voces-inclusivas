      ...
      <footer className="ext-footer">
        <div className="footer container-fluid">
            ...
            <div className="impulsan-logos logo gob">
              ...
              <div className="logos">
                <a href="https://mascr.org/" target="_blank">
                  <img className="logo-incubadora" src={config.imgs.logoFooter} alt="logo Incubadora de liderazgos" />
                </a>
                {/*  <a
                ...
                <a href="https://centreforpublicimpact.org/">
                  <img
                    ...
                    alt="logo Centre for Public Impact"
                  />
                </a>
          ...
          <nav className="menu nav">
            ...
            <Link to="/ayuda/acerca#contacto">Contacto</Link>
          </nav>
