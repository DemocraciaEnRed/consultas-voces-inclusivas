        ...
        <div className='section-icons col-md-10 offset-md-1'>
          <div className='row'>
            <div className='section-icon col-md-4'>
              ...
              />
              <div className='text'>
                <h5>Informate</h5> <strong> Conocé qué se está discutiendo y por qué es importante</strong>
                Accedé a información clara y accesible sobre las consultas públicas y los temas en debate.
            ...
            <div className='section-icon col-md-4'>
              ...
              />
              <div className='text'>
                <h5>Participá</h5> <strong> Sumate al diálogo y al debate ciudadano</strong>
                Aportá ideas y puntos de vista en los ejes de la consulta junto a otras personas.
            ...
            <div className='section-icon col-md-4'>
              ...
              />
              <div className='text'>
                <h5>Incidi</h5> <strong> Tu voz cuenta en las decisiones públicas</strong>
                Compartí tu opinión, voto o comentario y ayudá a que estas demandas lleguen a la agenda pública.
