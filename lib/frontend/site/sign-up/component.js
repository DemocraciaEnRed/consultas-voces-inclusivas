...
export default class SignUp extends Component {
  ...
  checkPassLength(e) {
    ...
    if (passLength.length < 6) {
      ...
      if (
        e.target.name === "re_password" &&
        e.target.value !== this.state.pass
      ) {
  ...
  createRandomString(e) {
    if (!config.allowPublicSignUp) {
      let pickRandomAdjective =
        randomWords.adjective[
        Math.floor(Math.random() * randomWords.adjective.length)
        ];
      let picRandomNoun =
        randomWords.adjective[
        Math.floor(Math.random() * randomWords.adjective.length)
        ...
        {this.state.active === "form" && (
          <div id="signup-form">
            ...
            >
              ...
              />
              <ul className={this.state.errors ? "form-errors" : "hide"}>
                {this.state.errors &&
              ...
              {config.allowPublicSignUp ? (
                ...
                <div className="form-group">
                  ...
                  <a
                    ...
                    onClick={this.createRandomString}
                  >
                    Crear una constraseña al azar
                  </a>
                </div>
              )}
              {config.allowPublicSignUp ? (
              ...
              <div className="form-group">
                {config.allowPublicSignUp ? (
                  <button
                    ...
                    className={
                      !this.state.loading
                        ? "btn btn-block btn-secondary btn-lg"
                        : "hide"
                    }
                    type="submit"
                  >
                  ...
                  <button
                    ...
                    onClick={this.onSubmitClick}
                    className={
                      !this.state.loading ? "btn btn-block btn-success" : "hide"
                    }
                    type="submit"
                  >
                    Registrar
                ...
                <button
                  className={
                    this.state.loading
                      ? "loader-btn btn btn-block btn-default btn-lg"
                      : "hide"
                  }
                >
              ...
              {(!!config.termsOfService || !!config.privacyPolicy) && (
                <div className="form-group accepting">
                  ...
                  {!!config.privacyPolicy && (
                    <Link to="/help/privacy-policy">{t("help.pp.title")}</Link>
                  )}
                </div>
              )}
            </FormAsync>
        ...
        {this.state.active === "congrats" &&
          (config.allowPublicSignUp ? (
            ...
            <div id="signup-message">
              ...
              <p className="lead">
                Hemos enviamos un correo electrónico al usuario con sus datos de
                acceso.
              </p>
              <p className="lead">
                Recuerdele al usuario que no te olvide revisar el Correo no
                Deseado.
              </p>
              <a className="btn btn-warning btn-sm" onClick={this.anotherUser}>
                Crear otro usuario
              </a>
            </div>
          ))}
