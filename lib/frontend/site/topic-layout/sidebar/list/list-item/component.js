      ...
      <li className='sidebar-link' data-id={this.props.item.id}>
        <Link
          ...
          <div className='item-tag'>
            <img
              className='tag-img'
              src={tagStore.tagImages[this.props.item.tag.image].url} alt='icono de etiqueta' />
            <img
              className='hexagon'
              src='/lib/backend/tags-images/hexagon.svg' alt='icono de etiqueda por defecto' />
          </div>
